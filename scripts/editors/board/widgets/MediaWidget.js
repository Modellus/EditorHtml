...
class MediaShape extends BaseShape {
    ...
    _positionMediaOverlay() {
        ...
        if (audioUrl && !videoUrl) {
            ...
            this._mediaOverlayDiv.style.left = `${topLeft.x}px`;
            this._mediaOverlayDiv.style.top = `${topLeft.y + screenHeight - audioBarHeight}px`;
            this._mediaOverlayDiv.style.width = `${screenWidth}px`;
            this._mediaOverlayDiv.style.height = `${audioBarHeight}px`;
            this._mediaOverlayDiv.style.transform = "";
        } else {
            this._mediaOverlayDiv.style.left = `${topLeft.x}px`;
    ...
    createElement() {
        ...
        this._mediaOverlayDiv.style.cssText = "position:fixed;display:none;z-index:100;overflow:hidden;";
