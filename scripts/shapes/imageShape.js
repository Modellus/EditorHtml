...
class ImageShape extends ChildShape {
    ...
    createImageDropZoneEditor() {
        ...
        const mediaSource = videoUrl || this.getImageSource();
        this.imageDropZoneControl = new ImageControl({
            imageSource: mediaSource,
            accept: "image/*,video/*",
            dropHint: "Drop an image or video, or click to select",
    ...
    draw() {
        ...
        this.videoForeignObject.setAttribute("width", this.properties.width);
        this.videoForeignObject.setAttribute("height", this.properties.height);
