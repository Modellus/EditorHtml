// Generated from the catalogue at https://modellus-api.interactivebook.workers.dev by electron/build-definitions.js.
    ...
    },
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "description": "How much of its swing the wave loses over every model unit it travels, so an oscillator far from the source is carried less than one near it. At zero the wave reaches the far end undiminished; raised, the swing falls away as e^{-\\delta\\cdot x} with the distance x from the source, which is what makes a chain die out along its length and the outer rings of a ripple fade."
            },
            {
                "id": "length",
                "label": "Length",
            ...
            {
                "id": "minimumY",
                "previousId": "displacementScale",
                "previousIdNegated": true,
                "label": "Least displacement",
                "valueType": "number",
                "defaultValue": -2,
                "category": "scale",
                "description": "The displacement the bottom of the body stands for. It is also the far end of the colouring: a ring carried this far in is painted as the body behind it and leaves nothing to see."
            },
            {
                "id": "maximumY",
                "previousId": "displacementScale",
                ...
                "defaultValue": 2,
                "category": "scale",
                "description": "The displacement the top of the body stands for. It is also the near end of the colouring: a ring carried this far out is painted in the wave's own colour, and one between the two ends is mixed of the two. While the wave is fitted to the body both ends are the object's to work out, and they are shown rather than edited."
            },
            {
                "id": "samples",
                "previousId": "elements",
            ...
            },
            {
                ...
                "description": "Which way an oscillator moves against the way the wave travels. Across it the chain rides up and down; along it the chain is squeezed and stretched into the compressions a sound wave carries. Both run along the width and swing in the height, so a wave taller than the body is cut off at its edge rather than drawn over the board. Radial turns the swing through the screen: an oscillator is a circle round a source in the middle, standing as far out as the wave has travelled to reach it, the way the chain stands further along the width the older it is — and what it is doing is painted rather than drawn, the wave's own colour where it is carried furthest out, the body behind it where it is carried furthest in, and half of each where it is not carried at all. The circles are as thick as the gap between them, so they meet edge to edge and the whole disc is covered from the source to the rim."
            },
            {
                "id": "wavefront",
                "label": "Wavefront",
            ...
            },
            {
                ...
                "minimum": 1,
                "maximum": 30,
                "description": "How big an oscillator is drawn. The radial wave has no use for it: its circles are as thick as the room between them, so that they meet."
            },
            {
                "id": "referenceIndex",
                ...
                "minimum": 0,
                "maximum": 200,
                "description": "The oscillator drawn in its own colour, so one of them can be followed. It is also the one the object reads: a wave handed to the model under a name the model leaves free is handed what this oscillator is doing. Zero marks none, and the first oscillator is read instead. The radial wave marks none of them: every circle in it is the wave's own colour mixed by how far it is carried, and one painted differently would read as a wave doing something the others are not."
            },
            {
                "id": "showArrows",
        ...
        "locals": [
            ...
            {
                "id": "damp",
                "formula": "\\max\\left(0,dampingValue\\right)"
            },
            {
                "id": "wf",
                "value": {
            ...
            {
                "id": "zeroY",
                "formula": "plotY+maximumY\\cdot ppy"
            },
            {
                "id": "spacing",
            ...
            {
                "id": "radialRoom",
                "formula": "\\frac{\\max\\left(plotW,plotH\\right)}{2}"
            },
            {
                "id": "ringSpacing",
                "formula": "\\frac{radialRoom}{count}"
            },
            {
                "id": "barHeight",
                    ...
                    "children": [
                        ...
                        },
                        {
                            ...
                            "bindings": {
                                ...
                                "radius": {
                                    "formula": "\\left(i+0.5\\right)\\cdot ringSpacing",
                                    "inputs": {
                                        "i": {
                                            "parameter": "$index"
                                        }
                                ...
                                "strokeWidth": {
                                    "formula": "ringSpacing+0.5"
                                },
                                "stroke": {
                                    "parameter": "waveColor"
                                },
                                "opacity": {
                                    "formula": "\\max\\left(0,\\min\\left(1,\\frac{\\left(d-minimumY\\right)}{spanY}\\right)\\right)",
                                    "inputs": {
                                        "d": {
                                            "choose": {
                                                "defines": {
        ...
        "axisFit": {
            "maximumY": {
                "formula": "\\max\\left(0.000001,s\\cdot1.08\\right)",
                "inputs": {
                    "s": {
                        "choose": {
                            "defines": {
            ...
            "minimumY": {
                "formula": "0-\\max\\left(0.000001,s\\cdot1.08\\right)",
                "inputs": {
                    "s": {
                        "choose": {
                            "defines": {
    ...
    },
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "maximum": 300,
                "bindable": false,
                "description": "The most points across the screen a wave is read at. A window holding fewer elements than that is drawn element by element, so the trace is the wave's own values; a window holding more is stepped through, the way a screen zoomed out past its own record is. Waves share the reading between them, so adding one costs the others some of their points."
            },
            {
                "id": "ticks",
                "label": "Axis ticks",
            ...
            },
            {
                ...
                "description": "A second line the cursor is measured against: clicking the screen moves it there, and the distance from it to the cursor is read out on the screen, along with what that distance is one of — the wavelength of a wave measured crest to crest, and the wavenumber that follows from it."
            },
            {
                "id": "markX",
                "label": "Mark position",
                ...
                "description": "Where the mark stands, in the units of the screen."
            },
            {
                "id": "hoverX",
                "label": "Pointer X",
            ...
            },
            {
                ...
                "defaultValue": "token:stroke.default",
                "category": "style",
                "description": "The crosshair, the mark and the readings taken from them."
            },
            {
                "id": "foregroundColor",
                "label": "Foreground",
                ...
                "category": "style",
                "userEditable": false,
                "description": "The numbers written along both axes. It is the shape's own foreground, edited on the row every shape has for it."
            },
            {
                "id": "borderColor",
                "label": "Border",
                ...
                "category": "style",
                "userEditable": false,
                "description": "The outline around the object and around its screen. It is the shape's own border, edited on the row every shape has for it."
            }
        ],
        "locals": [
            {
            ...
            {
                "id": "labelBandBottom",
                "formula": "ticksShown\\cdot labelFont\\cdot2.2"
            },
            {
                "id": "labelBandLeft",
                "formula": "ticksShown\\cdot\\max\\left(20,labelFont\\cdot3.4\\right)"
            },
            {
                "id": "waveCount",
                "value": {
            ...
            {
                "id": "budget",
                "formula": "\\lfloor\\frac{600}{\\max\\left(1,waveCount\\right)}\\rfloor+1"
            },
            {
                "id": "count",
                "formula": "\\max\\left(2,\\min\\left(\\min\\left(300,round\\left(samples\\right)\\right),\\min\\left(elements,budget\\right)\\right)\\right)"
            },
            {
                "id": "segments",
                "formula": "count-1"
            ...
            {
                "id": "step",
                "formula": "\\frac{spanX}{segments}"
            },
            {
                "id": "traceSegments",
                "formula": "waveCount\\cdot segments"
            },
            {
                "id": "playing",
                "value": {
            ...
            {
                "id": "deltaValue",
                "formula": "hoverX-markX"
            },
            {
                "id": "inverseDelta",
                "fallback": 0,
                "formula": "\\frac{1}{deltaValue}"
            },
            {
                "id": "deltaShown",
                "formula": "hoveringNow\\cdot markOn"
            },
            {
                "id": "readingsShown",
                "formula": "waveCount"
            ...
            {
                "id": "dotsShown",
                "formula": "hoveringNow\\cdot waveCount"
            },
            {
                "id": "precision",
                "value": {
            ...
            {
                "id": "legendTop",
                "formula": "plotBottom+labelBandBottom"
            },
            {
                "id": "swatchLength",
                "formula": "labelFont\\cdot1.6"
            },
            {
                "id": "labelX",
                "formula": "plotX+swatchLength+labelFont\\cdot0.6"
            },
            {
                "id": "readoutX",
                "formula": "plotX+labelFont\\cdot0.5"
            },
            {
                "id": "readoutY",
                "formula": "plotY+labelFont\\cdot1.2"
            },
            {
                "id": "dotRadius",
                "formula": "\\max\\left(1.5,labelFont\\cdot0.22\\right)"
            },
            {
                "id": "traceWidth",
                "value": {
        ...
        "root": {
            ...
            "children": [
                ...
                },
                {
                    ...
                    "bindings": {
                        "x1": {
                            "formula": "originX+\\left(minimumX+\\left(i-\\lfloor\\frac{i}{segments}\\rfloor\\cdot segments\\right)\\cdot step\\right)\\cdot scaleX",
                            "inputs": {
                                "i": {
                                    "parameter": "$index"
                                }
                        ...
                        "y1": {
                            "formula": "\\max\\left(plotY,\\min\\left(plotBottom,originY+\\left(v\\right)\\cdot scaleY\\right)\\right)",
                            "inputs": {
                                "v": {
                                    "element": {
                                        "termsRow": "waves",
                                        "row": {
                                            "formula": "\\lfloor\\frac{i}{segments}\\rfloor",
                                            "inputs": {
                                                "i": {
                                                    "parameter": "$index"
                                                }
                        ...
                        "x2": {
                            "formula": "originX+\\left(minimumX+\\left(\\left(i-\\lfloor\\frac{i}{segments}\\rfloor\\cdot segments\\right)+1\\right)\\cdot step\\right)\\cdot scaleX",
                            "inputs": {
                                "i": {
                                    "parameter": "$index"
                                }
                ...
                },
                {
                    ...
                    "parameters": {
                        ...
                        "minimumXProperty": "minimumX",
                        "maximumXProperty": "maximumX",
                        "minimumYProperty": "minimumY",
                        "maximumYProperty": "maximumY"
                    }
                },
                {
                    "id": "mark",
                    ...
                    "bindings": {
                        "x1": {
                            "formula": "\\max\\left(plotX,\\min\\left(plotRight,originX+markX\\cdot scaleX\\right)\\right)"
                        },
                        "x2": {
                            "formula": "\\max\\left(plotX,\\min\\left(plotRight,originX+markX\\cdot scaleX\\right)\\right)"
                        },
                ...
                },
                {
                    ...
                    "bindings": {
                        "centerX": {
                            "formula": "originX+hoverX\\cdot scaleX"
                        },
                        "centerY": {
                            "formula": "\\max\\left(plotY,\\min\\left(plotBottom,originY+\\left(v\\right)\\cdot scaleY\\right)\\right)",
                            "inputs": {
                ...
                },
                {
                    ...
                    "bindings": {
                        ...
                        "x2": {
                            "formula": "plotX+swatchLength"
                        },
                        "y1": {
                            "formula": "legendTop+\\left(i+0.5\\right)\\cdot lineHeight",
                            "inputs": {
                                "i": {
                                    "parameter": "$index"
                                }
    ...
    },
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "enumControl": "buttons",
                "category": "scale",
                "description": "How the angle is written. Radians are written as the portion of π they are, the way a scale numbered in π is numbered, so a quarter turn is π/2; degrees are numbers of degrees with the degree mark after them, so a quarter turn is 90 º. Both may be on at once, and then the degrees stand in brackets after the portion, for a reader learning to read one off the other. It says nothing about what the angle is — that is the model's to say — so changing it leaves the point where it stands. Only the angle is affected: the arc is a length, and the sine, the cosine and the tangent are numbers.",
                "choiceWriting": {
                    "radians": {
                        "suffix": "",
                        "style": "pi",
                        "radiansPer": 3.141592653589793
                    },
                    "degrees": {
                        "suffix": "º",
                        "suffixLatex": "^\\circ",
                        "radiansPer": 0.017453292519943295
                    }
                },
                "enumMultiple": true
            },
            {
                ...
                "maximum": 360,
                "category": "scale",
                "description": "How many equal parts of the circle a dragged angle lands on: four steps it a quarter turn at a time, six every sixth of a turn, twelve every thirty degrees and twenty-four every fifteen. The point follows the pointer while it is held and lands on the nearest part the moment it is let go, so nothing is fighting the reader on the way. It lands there exactly, so a third of a turn reads π/3. Left at nothing the point stays wherever the pointer took it."
            },
            {
                "id": "dragRadius",
                "label": "Drag the radius",
                "valueType": "boolean",
                "defaultValue": false,
                "category": "scale",
                "description": "Whether dragging the point stretches the circle as well as turning it. Left off the radius is whatever the row above it says and the drag only turns."
            },
            {
                "id": "showGrid",
                "label": "Grid",
            ...
            },
            {
                ...
                "defaultValue": true,
                "category": "display",
                "description": "The two axes, their arrows and the numbers where the circle crosses them."
            },
            {
                "id": "fitView",
                ...
                "defaultValue": true,
                "category": "display",
                "description": "Whether the view is fitted to the circle, so a radius the model changes keeps the same picture. Turned off the view is the reader’s: it reaches as far as it was last set to, and pulling one of the numbered ticks sets it, the way a chart’s axes are rescaled. A circle the drag may stretch never fits itself, since a view resizing under the drag would scale the radius straight back to the size it started at."
            },
            {
                "id": "showAngle",
                "label": "Angle",
                ...
                "defaultValue": true,
                "category": "display",
                "description": "The wedge swept from the zero direction."
            },
            {
                "id": "showRadius",
                "label": "Radius",
                ...
                "defaultValue": true,
                "category": "display",
                "description": "The line from the centre out to the point."
            },
            {
                "id": "showSine",
                "label": "Sine",
                ...
                "defaultValue": true,
                "category": "display",
                "description": "How far up the point stands, drawn on the vertical axis with a dashed line back to the point."
            },
            {
                "id": "showCosine",
                "label": "Cosine",
                ...
                "defaultValue": true,
                "category": "display",
                "description": "How far across the point stands, drawn on the horizontal axis with a dashed line back to the point."
            },
            {
                "id": "showTangent",
                "label": "Tangent",
                ...
                "defaultValue": false,
                "category": "display",
                "description": "The tangent: the line standing square to the radius where it meets the circle, drawn down to the horizontal axis, with the right triangle it closes shaded under it. A point standing straight up or straight down has no tangent."
            },
            {
                "id": "showArc",
                "label": "Arc",
                ...
                "defaultValue": false,
                "category": "display",
                "description": "The arc the point has swept along the circle, whose length is the radius times the angle in radians."
            },
            {
                "id": "backgroundColor",
                "label": "Background",
                ...
                "defaultValue": "none",
                "category": "style",
                "description": "The panel the circle is drawn on. Left unpainted, the board shows through."
            },
            {
                "id": "circleColor",
                "label": "Circle",
            ...
            },
            {
                ...
                "defaultValue": "token:text.secondary",
                "category": "style",
                "description": "The numbers along the axes and the letters naming them."
            },
            {
                "id": "radiusColor",
                "label": "Radius",
                ...
                "defaultValue": "token:stroke.accent",
                "category": "style",
                "description": "The line from the centre out to the point, and the plate its reading is written on."
            },
            {
                "id": "angleColor",
                "label": "Angle",
                ...
                "defaultValue": "#00695c",
                "category": "style",
                "description": "The wedge swept from the zero direction, and the plate its reading is written on."
            },
            {
                "id": "sineColor",
                "label": "Sine",
                ...
                "defaultValue": "token:stroke.warning",
                "category": "style",
                "description": "How far up the point stands, and the plate its reading is written on."
            },
            {
                "id": "cosineColor",
                "label": "Cosine",
                ...
                "defaultValue": "#2f9e44",
                "category": "style",
                "description": "How far across the point stands, and the plate its reading is written on."
            },
            {
                "id": "tangentColor",
                "label": "Tangent",
                ...
                "defaultValue": "#6a1b9a",
                "category": "style",
                "description": "The tangent, the triangle it closes, and the plate its reading is written on."
            },
            {
                "id": "arcColor",
                "label": "Arc",
                ...
                "defaultValue": "#f08c02",
                "category": "style",
                "description": "The arc swept along the circle, and the plate its reading is written on."
            },
            {
                "id": "viewRange",
                "label": "Range",
                ...
                "minimum": 0.05,
                "category": "state",
                "description": "How far the view reaches from the centre, in the units the circle is drawn in. It is set by pulling a numbered tick rather than typed, and it is read only while the view is not fitted to the circle."
            }
        ],
        "locals": [
            {
            ...
            {
                "id": "plotW",
                "formula": "\\max\\left(24,w-2\\cdot pad\\right)"
            },
            {
                "id": "plotH",
                "formula": "\\max\\left(24,h-2\\cdot pad\\right)"
            },
            {
                "id": "plotRight",
                "formula": "plotX+plotW"
            ...
            {
                "id": "shortSide",
                "formula": "\\min\\left(plotW,plotH\\right)"
            },
            {
                "id": "angleTerm",
                "value": {
            ...
            {
                "id": "readsPoint",
                "formula": "pointXDefined\\cdot pointYDefined"
            },
            {
                "id": "readsTangent",
                "formula": "\\left(1-readsPoint\\right)\\cdot\\left(1-angleDefined\\right)\\cdot tangentDefined"
            },
            {
                "id": "readsArc",
                "formula": "\\left(1-readsPoint\\right)\\cdot\\left(1-angleDefined\\right)\\cdot\\left(1-tangentDefined\\right)\\cdot arcDefined"
            },
            {
                "id": "readsAngle",
            ...
            {
                "id": "radius",
                "formula": "readsPoint\\cdot pointRadius+\\left(1-readsPoint\\right)\\cdot\\max\\left(0,radiusTerm\\right)"
            },
            {
                "id": "drawRadius",
                "formula": "\\max\\left(0.0001,radius\\right)"
            },
            {
                "id": "sumRX",
                "formula": "pointRadius+pointXTerm"
            },
            {
                "id": "onBackAxis",
                "formula": "\\left(1-\\min\\left(1,sumRX\\cdot1000000000\\right)\\right)\\cdot\\min\\left(1,pointRadius\\cdot1000000000\\right)"
            },
            {
                "id": "pointAngle",
                "formula": "\\left(1-onBackAxis\\right)\\cdot2\\cdot\\arctan\\left(\\frac{pointYTerm}{\\max\\left(sumRX,0.000000001\\right)}\\right)+onBackAxis\\cdot\\pi"
            },
            {
                "id": "tangentAngle",
                "formula": "\\arctan\\left(tangentTerm\\right)"
            },
            {
                "id": "arcAngle",
                "formula": "\\frac{arcTerm}{drawRadius}"
            },
            {
                "id": "angleToRadians",
                "value": {
                    "model": "radiansPerAngle"
                }
            },
            {
                "id": "unitsPerTurn",
                "formula": "\\frac{2\\cdot\\pi}{angleToRadians}"
            },
            {
                "id": "angleRadians",
                "formula": "readsPoint\\cdot pointAngle+readsTangent\\cdot tangentAngle+readsArc\\cdot arcAngle+readsAngle\\cdot angleTerm\\cdot angleToRadians"
            },
            {
                "id": "turn",
                "formula": "2\\cdot\\pi"
            ...
            {
                "id": "fitted",
                "formula": "fitViewRead\\cdot\\left(1-dragRadiusRead\\right)"
            },
            {
                "id": "viewRangeHeld",
                "value": {
            ...
            {
                "id": "heldRange",
                "formula": "\\max\\left(0.05,viewRangeHeld\\right)"
            },
            {
                "id": "viewSpan",
                "formula": "fitted\\cdot1.6\\cdot drawRadius+\\left(1-fitted\\right)\\cdot heldRange"
            },
            {
                "id": "unit",
                "formula": "\\frac{shortSide}{2\\cdot viewSpan}"
            },
            {
                "id": "rangeX",
                "formula": "\\frac{plotW}{2\\cdot unit}"
            },
            {
                "id": "rangeY",
                "formula": "\\frac{plotH}{2\\cdot unit}"
            },
            {
                "id": "leftValue",
                "formula": "-rangeX"
            ...
            {
                "id": "radiusPixels",
                "formula": "drawRadius\\cdot unit"
            },
            {
                "id": "cosValue",
                "formula": "\\cos\\left(angleRadians\\right)"
            },
            {
                "id": "sinValue",
                "formula": "\\sin\\left(angleRadians\\right)"
            },
            {
                "id": "cosMagnitude",
                "formula": "\\left|cosValue\\right|"
            },
            {
                "id": "cosSign",
                "formula": "1-2\\cdot\\max\\left(0,sign\\left(-cosValue\\right)\\right)"
            },
            {
                "id": "sinSign",
                "formula": "1-2\\cdot\\max\\left(0,sign\\left(-sinValue\\right)\\right)"
            },
            {
                "id": "pointValueX",
                "formula": "radius\\cdot cosValue"
            },
            {
                "id": "pointValueY",
                "formula": "radius\\cdot sinValue"
            },
            {
                "id": "pointX",
                "formula": "cx+pointValueX\\cdot unit"
            },
            {
                "id": "pointY",
                "formula": "cy-pointValueY\\cdot unit"
            },
            {
                "id": "arcValue",
            ...
            },
            {
                "id": "tangentValue",
                "fallback": 0,
                "formula": "\\tan\\left(angleRadians\\right)"
            },
            {
                "id": "cosNotZero",
                "formula": "\\min\\left(1,\\lfloor cosMagnitude\\cdot100000\\rfloor\\right)"
            },
            {
                "id": "showGridRead",
                "value": {
            ...
            {
                "id": "tangentReach",
                "formula": "0.32\\cdot radiusPixels"
            },
            {
                "id": "tangentAcross",
                "formula": "-tangentReach\\cdot sinValue"
            },
            {
                "id": "tangentUp",
                "formula": "-tangentReach\\cdot cosValue"
            },
            {
                "id": "tangentStartX",
                "formula": "pointX+tangentAcross"
            },
            {
                "id": "tangentStartY",
                "formula": "pointY+tangentUp"
            },
            {
                "id": "tangentEndX",
                "formula": "pointX-tangentAcross"
            ...
            {
                "id": "tangentOutward",
                "formula": "1-2\\cdot\\max\\left(0,sign\\left(sinValue\\cdot cosValue\\right)\\right)"
            },
            {
                "id": "tangentCornerX",
                "formula": "pointX+tangentOutward\\cdot tangentAcross"
            },
            {
                "id": "tangentCornerY",
                "formula": "pointY-tangentOutward\\cdot tangentUp"
            },
            {
                "id": "tangentShown",
                "formula": "showTangentRead\\cdot cosNotZero"
            },
            {
                "id": "backgroundRead",
                "value": {
            ...
            {
                "id": "labelFont",
                "formula": "\\max\\left(7,\\min\\left(13,0.055\\cdot shortSide\\right)\\right)"
            },
            {
                "id": "smallFont",
                "formula": "\\max\\left(6,\\min\\left(11,0.045\\cdot shortSide\\right)\\right)"
            },
            {
                "id": "hairline",
                "value": {
            ...
            {
                "id": "pointSize",
                "formula": "\\max\\left(1.75,\\min\\left(3.5,0.014\\cdot shortSide\\right)\\right)"
            },
            {
                "id": "wedgeRadius",
                "formula": "\\max\\left(10,\\min\\left(0.3\\cdot radiusPixels,32\\right)\\right)"
            },
            {
                "id": "unitRight",
                "formula": "cx+radiusPixels"
            },
            {
                "id": "unitLeft",
                "formula": "cx-radiusPixels"
            ...
            {
                "id": "tickReach",
                "formula": "\\max\\left(2,0.35\\cdot smallFont\\right)"
            },
            {
                "id": "tickAbove",
                "formula": "cy-tickReach"
            },
            {
                "id": "tickBelow",
                "formula": "cy+tickReach"
            ...
            {
                "id": "axisReachDown",
                "formula": "plotBottom-cy"
            },
            {
                "id": "radiusMidX",
                "formula": "cx+0.68\\cdot\\left(pointX-cx\\right)"
            },
            {
                "id": "radiusMidY",
                "formula": "cy+0.68\\cdot\\left(pointY-cy\\right)"
            },
            {
                "id": "anglePillRadius",
                "formula": "wedgeRadius+labelFont\\cdot2.4"
            },
            {
                "id": "anglePillX",
                "formula": "cx+anglePillRadius\\cdot\\cos\\left(bisector\\right)"
            },
            {
                "id": "anglePillY",
                "formula": "cy-anglePillRadius\\cdot\\sin\\left(bisector\\right)"
            },
            {
                "id": "radiusPillX",
                "formula": "radiusMidX-labelFont\\cdot1.8\\cdot sinValue"
            },
            {
                "id": "radiusPillY",
                "formula": "radiusMidY-labelFont\\cdot1.8\\cdot cosValue"
            },
            {
                "id": "cosinePillX",
                "formula": "cx+0.55\\cdot\\left(pointX-cx\\right)"
            },
            {
                "id": "cosinePillY",
                "formula": "cy+sinSign\\cdot labelFont\\cdot1.6"
            },
            {
                "id": "sinePillX",
                "formula": "cx-cosSign\\cdot labelFont\\cdot3.4"
            },
            {
                "id": "sinePillY",
                "formula": "cy+0.55\\cdot\\left(pointY-cy\\right)"
            },
            {
                "id": "arcPillRadius",
                "formula": "radiusPixels+labelFont\\cdot1.9"
            },
            {
                "id": "arcPillX",
                "formula": "cx+arcPillRadius\\cdot\\cos\\left(bisector\\right)"
            },
            {
                "id": "arcPillY",
                "formula": "cy-arcPillRadius\\cdot\\sin\\left(bisector\\right)"
            },
            {
                "id": "tangentCornerAcross",
                "formula": "tangentCornerX-cx"
            },
            {
                "id": "tangentCornerUp",
                "formula": "tangentCornerY-cy"
            },
            {
                "id": "tangentCornerReach",
                "formula": "\\max\\left(1,\\sqrt{tangentCornerAcross^2+tangentCornerUp^2}\\right)"
            },
            {
                "id": "tangentStep",
                "formula": "1+\\frac{labelFont\\cdot1.8}{tangentCornerReach}"
            },
            {
                "id": "tangentPillX",
                "formula": "\\max\\left(plotX+labelFont\\cdot3,\\min\\left(plotRight-labelFont\\cdot3,cx+tangentCornerAcross\\cdot tangentStep\\right)\\right)"
            },
            {
                "id": "tangentPillY",
                "formula": "\\max\\left(plotY+labelFont,\\min\\left(plotBottom-labelFont,cy+tangentCornerUp\\cdot tangentStep\\right)\\right)"
            },
            {
                "id": "pointColor",
                "value": {
            ...
            },
            {
                ...
                "value": {
                    "concat": [
                        "M ",
                        {
                            "parameter": "tangentStartX"
                        },
                        " ",
                        {
                            "parameter": "tangentStartY"
                        },
                        " L ",
                        {
                            "parameter": "tangentCornerX"
                        },
                        " ",
                        {
                            "parameter": "tangentCornerY"
                        },
                        " L ",
                        {
                            "parameter": "tangentEndX"
                        },
                        " ",
                        {
                            "parameter": "tangentEndY"
                        },
                        " Z"
                    ]
                }
            ...
            {
                "id": "grabSize",
                "formula": "\\max\\left(9,0.055\\cdot shortSide\\right)"
            },
            {
                "id": "grabColor",
                "value": {
                ...
                },
                {
                    ...
                    "children": [
                            ...
                            "children": [
                                {
                                    ...
                                    "parameters": {
                                        ...
                                        "showBorder": false,
                                        "rangeProperty": {
                                            "parameter": "rangeProperty"
                                        },
                                        "color": {
                                            "parameter": "axisColor"
                                        },
                                        "labelColor": {
                                            "parameter": "axisLabelColor"
                                        },
                                        "fontSize": {
                                            "parameter": "tickFont"
                                        },
                                ...
                                },
                                {
                                    ...
                                    "parameters": {
                                        ...
                                        "angle": 90,
                                        "length": {
                                            "parameter": "axisReachRight"
                                        },
                                        "tailLength": {
                                            "parameter": "axisReachLeft"
                                        },
                                        "width": {
                                            "parameter": "axisWidth"
                                        },
                                ...
                                },
                                {
                                    ...
                                    "parameters": {
                                        ...
                                        "angle": 0,
                                        "length": {
                                            "parameter": "axisReachUp"
                                        },
                                        "tailLength": {
                                            "parameter": "axisReachDown"
                                        },
                                        "width": {
                                            "parameter": "axisWidth"
                                        },
                        ...
                        },
                        {
                            ...
                            "bindings": {
                                "d": {
                                    "parameter": "trianglePath"
                                },
                                "fill": {
                                    "parameter": "tangentColor"
                                }
                            }
                        },
                        {
                    ...
                    "children": [
                        {
                            ...
                            "bindings": {
                                "x": {
                                    "parameter": "anglePillX"
                                },
                                "y": {
                                    "parameter": "anglePillY"
                                }
                            }
                        },
                        {
                            ...
                            "bindings": {
                                "x": {
                                    "parameter": "radiusPillX"
                                },
                                "y": {
                                    "parameter": "radiusPillY"
                                }
                            }
                        },
                        {
                            ...
                            "bindings": {
                                "x": {
                                    "parameter": "cosinePillX"
                                },
                                "y": {
                                    "parameter": "cosinePillY"
                                }
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "bindings": {
                                "x": {
                                    "parameter": "tangentPillX"
                                },
                                "y": {
                                    "parameter": "tangentPillY"
                                }
                            }
                        },
                        {
                    ...
                    "behaviours": [
                        {
                            ...
                            "angleProperty": "angleVariable",
                            "radiusVariable": {
                                "parameter": "radiusVariable"
                            },
                            "radiusProperty": "radiusVariable",
                            "stretch": {
                                "parameter": "dragRadius"
                            },
                            "minimumRadius": 0,
                            "maximumRadius": {
                                "parameter": "largestRadius"
                            },
                            "xVariable": {
                                "parameter": "pointXVariable"
                            },
                            "xProperty": "pointXVariable",
                            "yVariable": {
                                "parameter": "pointYVariable"
                            },
                            "yProperty": "pointYVariable",
                            "tangentVariable": {
                                "parameter": "tangentVariable"
                            },
                            "tangentProperty": "tangentVariable",
                            "arcVariable": {
                                "parameter": "arcVariable"
                            },
                            "arcProperty": "arcVariable",
                            "snapDivisions": {
                                "parameter": "snapDivisions"
                            },
                            "hoverFill": {
                                "parameter": "grabColor"
                            },
