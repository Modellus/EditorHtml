// Generated by electron/build-definitions.js from the objects the catalogue has flagged as bundled.
// Do not edit by hand: change the object in the block shape editor or its bundle flag in the
// catalogue, then run `npm run build:definitions`. This copy is the one the objects were seeded
// from and will be replaced wholesale by the next build.
