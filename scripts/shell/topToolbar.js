class TopToolbar {
    ...
    _create() {
        $("#toolbar").dxToolbar({
            ...
            items: [
                ...
                ...ModellusShapeToolbar.editorItems(this.shell),
                {
                    location: "center",
                    template() {
        ...
        this._whatsNewPopup = new WhatsNewPopup(translations);
        ...
        this.chartButton = $("#chart-button").dxDropDownButton("instance");
    ...
    async showWhatsNewIfNeeded() {
        ...
        this._whatsNewPopup.show(entries);
    }
